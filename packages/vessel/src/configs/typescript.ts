...
const config = require('@manifest-ui/tsconfig/tsconfig.json') as TypeScriptConfig;
...
if (tool.package.workspaces) {
  Object.assign(
    options,
    (require('@manifest-ui/tsconfig/tsconfig.workspaces.json') as TypeScriptConfig).compilerOptions,
  );
}
